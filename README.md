## azure_iot_sdk_c (jazzy) - 1.14.0-2

The packages in the `azure_iot_sdk_c` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy azure_iot_sdk_c -y` on `Mon, 12 Jan 2026 06:43:17 -0000`
...
## azure_iot_sdk_c (kilted) - 1.14.0-3

The packages in the `azure_iot_sdk_c` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted azure_iot_sdk_c -y` on `Mon, 12 Jan 2026 06:08:19 -0000`
...
- upstream repository: https://github.com/Azure/azure-iot-sdk-c.git
- release repository: https://github.com/ros2-gbp/azure_iot_sdk_c-release.git
- rosdistro version: `1.14.0-2`
- old version: `1.14.0-2`
- new version: `1.14.0-3`
...
## azure_iot_sdk_c (rolling) - 1.14.0-4

The packages in the `azure_iot_sdk_c` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling azure_iot_sdk_c -y` on `Thu, 08 Jan 2026 07:49:12 -0000`
...
- upstream repository: https://github.com/Azure/azure-iot-sdk-c.git
- release repository: https://github.com/ros2-gbp/azure_iot_sdk_c-release.git
- rosdistro version: `1.14.0-3`
- old version: `1.14.0-3`
- new version: `1.14.0-4`
...
## azure_iot_sdk_c (rolling) - 1.14.0-3

The packages in the `azure_iot_sdk_c` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling azure_iot_sdk_c` on `Wed, 07 Jan 2026 07:49:21 -0000`
...
## azure_iot_sdk_c (rolling) - 1.14.0-2

The packages in the `azure_iot_sdk_c` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling azure_iot_sdk_c` on `Mon, 05 Jan 2026 09:23:44 -0000`
